(function($) {
	...
	var methods = {
		init : function(options) {
			...
			return this.each(function() {
				...
				var settings = {
					...
					'left' : 0,
					'top' : 0,
					'topContClass' : 'v0idtooltipconttop',
					'bottomContClass' : 'v0idtooltipcontbottom',
					'leftContClass' : 'v0idtooltipcontleft',
					'rightContClass' : 'v0idtooltipcontright',
		...
		show : function() {
			...
			case 'left':
				...
				v0idtooltipCont.removeAttr('class').addClass(data.settings.leftContClass);
			...
			case 'right':
				...
				v0idtooltipCont.removeAttr('class').addClass(data.settings.rightContClass);
				textCont.removeAttr('class').addClass(data.settings.textClass);
			...
			case 'bottom':
				...
				v0idtooltipCont.removeAttr('class').addClass(data.settings.bottomContClass);
				textCont.removeAttr('class').addClass(data.settings.textClass);
			...
			default:
				...
				v0idtooltipCont.removeAttr('class').addClass(data.settings.topContClass);
				textCont.removeAttr('class').addClass(data.settings.textClass);
	...
	var getv0idtooltipHTML = function(settings) {
		...
		var v0idtooltipconttop = $("<div voidtooltip='conttop' class='"+settings.topContClass+"'></div>").append($("<div voidtooltip='conttext' class='"+settings.textClass+"'></div>")).append($("<div voidtooltip='arrowdown' class='"+settings.downArrowClass+"'></div>"));
		var v0idtooltipcontbottom = $("<div voidtooltip='contbottom' class='"+settings.bottomContClass+"'></div>").append($("<div voidtooltip='arrowup' class='"+settings.upArrowClass+"'></div>")).append($("<div voidtooltip='conttext' class='"+settings.textClass+"'></div>"));
		var v0idtooltipcontleft = $("<div voidtooltip='contleft' class='"+settings.leftContClass+"'></div>").append($("<div voidtooltip='conttext' class='"+settings.textClass+"' style='float:left;'></div>")).append($("<div voidtooltip='arrowright' class='"+settings.rightArrowClass+"'></div>"));
		var v0idtooltipcontright = $("<div voidtooltip='contright' class='"+settings.rightContClass+"'></div>").append($("<div voidtooltip='arrowleft' class='"+settings.leftArrowClass+"'></div>")).append($("<div voidtooltip='conttext' class='"+settings.textClass+"' style='float:right;'></div>"));
